                    ...
                    child: ListView(
                      ...
                      children: [
                        ...
                        sw == false
                            ? Container(
                                margin:
                                    EdgeInsets.only(left: 0, top: 0, right: 80),
                                child: Text(
                                  'Description : ',
                                  style: TextStyle(
                                      fontSize: 10,
                            ...
                            : Container(
                                margin:
                                    EdgeInsets.only(left: 80, top: 0, right: 5),
                                child: Text(
                                  'الوصف : ',
                                  style: TextStyle(
                                      fontSize: 10,
                   ...
                   child: ListView(
                     children: [
                       UserAccountsDrawerHeader(
                         ...
                         accountName: Container(child: Text('yehya')),
                         accountEmail: Container(
                           child: FittedBox(child: Text('yehyaelzaeem7@gmail.com')),
                         ),
                           ...
                           Navigator.push(
                               ...
                               MaterialPageRoute(
                                   ...
                                   settings: RouteSettings(
                                       arguments: Collection(collect: 'Pizza'))));
                         },
                       ),
                       InkWell(
                         ...
                         onTap: () {
                           Navigator.push(
                               ...
                               MaterialPageRoute(
                                   builder: (context) => Screen1(),
                                   settings: RouteSettings(
                                       arguments: Collection(collect: 'Pies'))));
                         },
                       ),
                       InkWell(
                         ...
                         onTap: () {
                           Navigator.push(
                               ...
                               MaterialPageRoute(
                                   builder: (context) => Screen1(),
                                   settings: RouteSettings(
                                       arguments: Collection(collect: 'Hawawshy'))));
                         },
                       ),
                         ...
                         onTap: () {
                           Navigator.push(
                               ...
                               MaterialPageRoute(
                                   builder: (context) => Screen1(),
                                   settings: RouteSettings(
                                       arguments: Collection(collect: 'Sweet Pie'))));
                         },
                       ),
                                           ...
                                           MaterialPageRoute(
                                             ...
                                             settings: RouteSettings(
                                               arguments: Recomm(
                                                 ...
                                                 collection: "Pizza",
                                                 description_ar:
                                                     '${snapshot.data?.docs[i]['الوصف']}',
                                                 ingredients_ar:
                                                     '${snapshot.data?.docs[i]['المكونات']}',
                                                 name_ar:
                                                     '${snapshot.data?.docs[i]['الاسم']}',
                                               ),
                                             ),
                                           ),
                                         );
